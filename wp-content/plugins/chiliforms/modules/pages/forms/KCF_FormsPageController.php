 ...
 */
class KCF_FormsPageController extends KCF_BaseFormsPageController {

	public function page_html() {
		$translations = KCF_i18n::get_translations();

		?>
		<div id="kcf-forms-mount" class="kcf-app-mount">
