...
[Formilla Edge](http://www.FormillaEdge.com/?u=wp "Formilla Edge") allows you to create lightbox modals, website bars, and corner widgets on your WordPress website.  We offer **FREE and Premium** packages.  Brought to you by the same team that built the popular and highly rated [Formilla Live Chat](https://wordpress.org/plugins/formilla-live-chat/ "Formilla Live Chat") plugin, with over 9,000 active installs! 
