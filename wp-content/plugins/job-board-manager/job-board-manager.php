...
class JobBoardManager{
	...
	define('job_bm_plugin_version', '2.0.20' );
	...
	add_action( 'plugins_loaded', array( $this, 'job_bm_load_textdomain' ));
	...
	public function job_bm_load_textdomain() {
...
*/		
	...
	public function job_bm_front_scripts(){
		...
		wp_enqueue_script('scripts-form', plugins_url( '/assets/front/js/scripts-form.js' , __FILE__ ) , array( 'jquery' ));		
