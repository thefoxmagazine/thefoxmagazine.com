...
if( $archive_more_style == 'ajax' ) {
	...
	echo '<div class="paginate">';
	echo '<div keywords="'.$keywords.'" meta_keys="'.implode( ',',$meta_keys ).'"  location="'.$location.'"  job_status="'.$job_status.'"  job_type="'.$job_type.'" company_name="'.$company_name.'" paged=2 class="paginate-ajax">';
