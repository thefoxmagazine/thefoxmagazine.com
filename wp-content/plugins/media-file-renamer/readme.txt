...
* Info 1: You will notice the 'Rename 1 by 1' section. I would like to remove it, and move the 'Rename in Bulk' section above the Settings. That will free your WordPress UI of this screen. Good idea? Let me know here: https://wordpress.org/support/topic/ui-enhancements-bulk-and-rename-1-by-1/.
* Info 2: If you have some time, please review me nicely at https://wordpress.org/support/view/plugin-reviews/media-file-renamer?rate=5#postform. Thanks to you, I get a lot of motivation to make this plugin better. Merry Christmas! :)
