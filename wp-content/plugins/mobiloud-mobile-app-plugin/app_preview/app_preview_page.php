<div class="wrap">
	<div class="ml_header">
		...
		<a id="intercom" class="ml-contact-button button button-primary" href="mailto:h89uu5zu@incoming.intercom.io">Contact
			Us</a>
		...
		<div class='ml-preview-app-design'>
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<input size="36" type="text" id="contactName" name="contactName" placeholder="Enter your name"
				...
				<tr valign="top">
					...
					<td>
						<input size="36" type="email" id="email" name="email" placeholder="Enter your email"
				...
				<tr valign="top">
					...
					<td>
						<input size="36" type="text" id="website" name="website" placeholder="Enter your website"
			...
			<p class="submit">
				<?php add_thickbox(); ?>
				<a href="" class="thickbox button button-hero button-primary signup-button">See Live Preview &amp Sign
					Up</a>
			</p>
		</div>
	...
	<div id="ml_preview_loading"><img src="<?php echo MOBILOUD_PLUGIN_URL; ?>/images/spinner.gif"
	                                  alt="Loading..."/><br/>Loading Preview...
	</div>

	<small> By using Mobiloud you agree to Mobiloud's <a
			href="http://mobiloud.com/terms.php<?php echo get_option( 'affiliate_link', null ); ?>">terms of service</a>
		and <a href="https://www.iubenda.com/privacy-policy/435863/legal">privacy policy</span></a></small>
</div>
