...
<head>
	...
	<link href="<?php echo plugins_url( 'mobiloud-mobile-app-plugin/comments/css/styles.css' ); ?>" rel="stylesheet"
	      media="all"/>
	<link href="<?php echo plugins_url( 'mobiloud-mobile-app-plugin/comments/css/_typeplate.css' ); ?>" rel="stylesheet"
	      media="all"/>
</head>
<body>
