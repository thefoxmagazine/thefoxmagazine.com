...
Description: Easily publish iOS and Android mobile apps for your WordPress site.
Author: 50pixels
Version: 3.4.8
Author URI: http://www.mobiloud.com
*/

define( 'MOBILOUD_PLUGIN_VERSION', "3.4.8" );
...
include_once MOBILOUD_PLUGIN_DIR . 'api/MLAPI.php';
include_once MOBILOUD_PLUGIN_DIR . 'api/MLRestAPI.php';
...
if ( is_admin() ) {
	...
	require_once( MOBILOUD_PLUGIN_DIR . 'class.mobiloud-feedback.php' );
	$feedback = new Mobiloud_Feedback();
}
...
add_action( 'init', 'mobiloud_plugin_init' );
add_filter( 'query_vars', array( 'MLAPI', 'add_query_vars' ), 0 );
add_action( 'parse_request', array( 'MLAPI', 'check_requests' ), 0 );
