...
if ( strlen( get_option( 'ml_pb_app_id' ) ) > 10 && strlen( get_option( 'ml_pb_secret_key' ) ) ) {
	...
	?>
	<link rel='stylesheet' href="<?php echo MOBILOUD_PLUGIN_URL . '/notifications.css'; ?>" type='text/css'
	      media='all'/>
	<div class="wrap">
		<div class="ml_header">
			<h1 style="float: left;">Mobiloud Push Notifications</h1>
			<a id="intercom" style="float: right;" class="ml-contact-button button button-primary"
			   href="mailto:h89uu5zu@incoming.intercom.io">Contact Us</a>
			<div style="clear:both;"></div>

			<?php $registeredDevicesCount = ml_registered_devices_count(); ?>
			<div style="float:right;">
				<h3 style="float:right;"><u>Registered Devices</u><br/>
					Android: <?php echo $registeredDevicesCount['android'] !== null ? ( $registeredDevicesCount['android'] == 0 ? 'No Devices Registered' : $registeredDevicesCount['android'] ) : 'Unknown'; ?>
					<br/>
	...
	<iframe height="2000px"
	        src="https://push.mobiloud.com/iframes/notifications/<?php echo get_option( 'ml_api_key' ); ?>/<?php echo get_option( 'ml_secret_key' ); ?>"
	        width="100%">
	</iframe>
<?php } else {
	echo '
