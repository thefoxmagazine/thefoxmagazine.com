	...
	<form method="post" action="<?php echo admin_url( 'admin.php?page=mobiloud_push&tab=settings' ); ?>">
		...
		<div class='ml-col-row'>
			...
			<div class='ml-col-half'>
				...
				<select id="ml_push_notification_categories" name='ml_push_notification_categories[]'
						data-placeholder="Select Categories..." style="width:350px;" multiple class="chosen-select">
					<option></option>
