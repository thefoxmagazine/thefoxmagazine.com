	...
	<form method="post" action="<?php echo admin_url( 'admin.php?page=mobiloud_settings&tab=editor' ); ?>">
		...
		<div class='ml-col-twothirds'>
			...
			<p>Read more in our <a
					href="http://www.mobiloud.com/help/knowledge-base/using-the-code-editor/<?php echo get_option( 'affiliate_link', null ); ?>?utm_source=wp-plugin-admin&utm_medium=web&utm_campaign=editor"
