...
Donate link: http://twardes0.webd.pl/wordpress/sitemap-index-plugin
Tags: sitemap, sitemap-index, google-sitemap, sitemapindex, index, google, ask, live, yahoo, xml, xml-sitemap, submit, plugin, ping, posts, pages, tags, categories, sitemaps, splits, generate, links, search-engine, one-click
...
*	One-Click install sitemap
*	Creates posts, pages, tags and categories sitemaps
*	Splits sitemaps on many parts
*	Does not create permanent .xml or .xml.gz files on server
*	Dynamic generation of sitemaps
*	Possibility of setting number of links per sitemap
*	Submits created sitemap to the most popular search engines (Google, Bing)
*	Sitemap is generated only when it is being loaded
