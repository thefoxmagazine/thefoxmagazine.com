...
<header id="header" class="<?php echo esc_attr(implode(' ', $header_class)); ?>">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="header-wrapper">
                        ...
                        <!-- Fox Logomark centered -->
                        <div class="hidden-xs text-center">
                          <a href="http://thefoxmagazine.com"><img src="http://thefoxmagazine.com/wp-content/themes/tana-child/images/logomark.png" alt="Fox Logo" style="width: 60px; margin: 32px auto; padding: 0px auto;"></a>
                        </div>
    ...
    if( $ticker_enabled=='1'):
        ...
        $ticker_title = !empty($ticker_title) ? $ticker_title : esc_html__('Daily Inspiration', 'tana');
    endif;
    ...
    <div class="panel-ticker">
		...
		<!-- Weather and Date commented out by Steve Orchosky -->
