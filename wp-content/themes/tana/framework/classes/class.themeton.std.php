...
class ThemetonStd{
    ...
    public static function google_fonts(){
        global $themeton_google_fonts;
        if( !empty($themeton_google_fonts) )
            return $themeton_google_fonts;
        
        require_once get_template_directory() . '/framework/functions/google-fonts.php';
        $themeton_google_fonts = get_google_webfonts();
