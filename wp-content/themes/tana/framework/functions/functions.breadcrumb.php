...
class WPSEO_Options_Extend {
    ...
    public static function get_all() {
        ...
        $all_options['breadcrumbs-404crumb']      = esc_html__('Error 404: Page not found', 'tana');
        $all_options['breadcrumbs-archiveprefix'] = esc_html__('Archives for', 'tana');
        $all_options['breadcrumbs-home']          = esc_html__('Home', 'tana');
        $all_options['breadcrumbs-searchprefix']  = esc_html__('You searched for', 'tana');
...
function themeton_breadcrumb( $before = '', $after = '', $display = true ) {
